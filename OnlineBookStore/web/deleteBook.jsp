        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 offset-md-4">
                    <div class="card">
                        <div class="card-header primary-background text-white text-center"><p>Serach Book For Delete</p></div>
                        <div class="card-body">
                            <form id="s-form" action="deleteBookServlet" method="POST">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="container">
                                <button type="submit" class="btn btn-primary align-items-center">Delete</button>
                                 </div>
                            </form>             
                        </div>
                    </div>
